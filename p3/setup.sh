...
mv ./Semantic_Video_Segmentation/p3/semantic-segmentation-helpers/video_2_jpg.py ./semantic-segmentation/
rm ./semantic-segmentation/demo_folder.py
mv ./Semantic_Video_Segmentation/p3/semantic-segmentation-helpers/demo_folder.py ./semantic-segmentation/
